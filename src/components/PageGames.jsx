...
export default function PageGames() {
  ...
  const gamesData = [
    ...
    { id: 'fhc_1m', name: '一分鱼虾蟹', category: ['hot', 'lottery'], img: '游戏图标/鱼虾蟹.png', isLive: true, roomid: '702010' },
    { id: 'fhc_5m', name: '五分鱼虾蟹', category: ['lottery'], img: '游戏图标/鱼虾蟹.png', isLive: true, roomid: '702020' },
    { id: 'fhc_10m', name: '十分鱼虾蟹', category: ['lottery'], img: '游戏图标/鱼虾蟹.png', isLive: true, roomid: '702030' },
    { id: 'bac_a1', name: '百家乐A1', category: ['hot', 'lottery'], img: '游戏图标/百家乐.png', isLive: true, roomid: '901010' },
    { id: 'bac_a2', name: '百家乐A2', category: ['lottery'], img: '游戏图标/百家乐.png', isLive: true, roomid: '901020' },
    { id: 'bac_a3', name: '百家乐A3', category: ['lottery'], img: '游戏图标/百家乐.png', isLive: true, roomid: '901030' },
